...
function Posts() {
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => (
                <div className="">
                    <img style={{ height: 30, width: 30, borderRadius: 15, marginRight: 10 }} src={params.row.UserPic} alt="" />
                    {params.row.username}
                ...
                <>
                    ...
                    <Modal show={show} onHide={handleClose}>
                        ...
                        <Modal.Footer>
                            ...
                            <Button variant="primary" onClick={() => handleDelete(params.row.id)}>
                                Delete
                            </Button>
                        </Modal.Footer>
                    </Modal>
