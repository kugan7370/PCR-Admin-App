    ...
    return (
        <div className='sidebar  p-4'>
            ...
            <div className="profile-details  align-items-center d-flex flex-column mb-5">
                <img src={userData.pro_pic} className='pro-image rounded-circle' alt="" />
                <span className='mt-1'>{userData.username}</span>
            </div>
            <Nav defaultActiveKey="/home" className="flex-column text-white">
                <Link className="d-flex align-items-center text-white mb-2   text-decoration-none " to="/dashboard">
                    <Dashboard className=' fs-5 me-2  ' />
                    <h6 className='mt-2 active'>Dashboard</h6>
                </Link>

                <Link className="d-flex align-items-center text-white mb-2   text-decoration-none" to="/Posts">
                    <MenuBook className=' fs-5 me-2' />
                    <h6 className='mt-2'>Posts</h6>
                </Link>

                <Link to="/users" className="d-flex align-items-center mb-2 text-white text-decoration-none ">
                ...
                <Nav.Link className="d-flex align-items-center text-white mt-5 text-decoration-none p-0" href="/" >
