                ...
                <Container fluid>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="ms-auto">
                            {userData ?
                                <Nav.Link className='d-flex align-items-center ' href="#features">
                                    <div className="profile-img">
                                        <img src={userData.photoURL} className='img-fluid h-100 w-100 rounded-circle' alt="" />
                                    </div>
                                    <span className='ms-2' >{userData.displayName}</span>
                                </Nav.Link> :
